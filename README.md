# SQL-data-analytics-pizza-sales

ABOUT THE PROJECT: Analyzed 1 year of pizza sales data to identify key trends, customer purchasing patterns, and business insights. Built reports and dashboards to         answer stakeholder requirements, support decision-making, and improve sales and operational performance.
...
CHARTS REQUIREMENT
We would like to visualize various aspects of our pizza sales data to gain insights and understand key trends. We have identified the following requirements fo creating charts:
